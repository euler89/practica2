...
static const struct mqtt_connect_client_info_t mqtt_client_info = {
    ...
    .client_user = "rdz89",
    .client_pass = "aio_nxjf03xd8qaawHWBd7NugE8J6FIN",
    .keep_alive  = 100,
    .will_topic  = NULL,
    .will_msg    = NULL,
    .will_qos    = 0,
...
static void mqtt_subscribe_topics(mqtt_client_t *client)
{
	...
	static const char *topics[] = {"rdz89/feeds/fan"};
    int qos[]                   = {0, 1};
    err_t err;
    int i;
...
{
    static const char *topic   = "rdz89/feeds/ws-humidity";
    int humidity_number = printRandom(60,69);
    char *humidity;
    switch (humidity_number)
    	{
    	  case 60:
    		  humidity = "60";
    	    break;
    ...
    static const char *topic2   = "rdz89/feeds/ws-temperature";
        int temperature_number = printRandom(20,29);
        char *temperature;
        ...
        static const char *topic3   = "rdz89/feeds/fan";
        char* fan_ind = "0";

        if ((temperature_number > 25) && (humidity_number >65 ))
        	fan_ind = "1";
    ...
    mqtt_publish(mqtt_client, topic, humidity, strlen(humidity), 1, 0, mqtt_message_published_cb, (void *)topic);
    mqtt_publish(mqtt_client, topic2, temperature, strlen(temperature), 1, 0, mqtt_message_published_cb, (void *)topic2);
    mqtt_publish(mqtt_client, topic3, fan_ind, strlen(fan_ind), 1, 0, mqtt_message_published_cb, (void *)topic3);
}
...
/*!
 * @brief Generates and prints a random number in range
 */
int printRandom(int lower, int upper)
{
    int num = (rand() %
